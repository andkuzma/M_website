    ...
    const timeline = [
        {
            ...
            text: "Сьогодні особливий день🎂"
        },
        {
            start: 620,
            end: 1000,
            text: "День, коли у світі стало більше тепла, краси і світла, бо в ньому з'явилася Мар'янка ❤️",
        },
        {
            start: 1000,
            end: 1500,
            text: "Я хочу побажати тобі щирих усмішок, спокою в серці і людей, поруч з якими добре"
        },
        {
            start: 1500,
            end: 2000,
            text: "Нехай кожен новий день приносить тобі маленькі радості і великі причини бути щасливою"
        },
        {
            start: 2000,
            end: 2500,
            text: "Нехай здійснюються навіть ті мрії, про які ти поки що нікому не розповідаєш ✨",
        },
        {
            start: 2500,
            end: 2750,
        ...
        },
        {
            ...
            text: "А сьогодні просто насолоджуйся своїм днем 🎉"
        },
        {
            start: 3000,
            end: 6500,
            text: "Мар'янко, з Днем народження ❤️ Бажаю тобі здоров'я, щастя, здійснення мрій та багато приводів для усмішок ✨"
        },
	{
    	    start: 6500,
            permanent: true,
