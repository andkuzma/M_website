...
const runAwaySteps = [
    ...
    { text: "💧Вода бачить намилені руки Мар'яни і думає: 'Ой, знову понаднормові...' 😂", gif: "public/images/final.gif" },
    { text: "Я більше не знаю, клацай давай", gif: "public/images/final.gif" },
    { text: "🧼Мило дивиться на Мар'яну і думає: 'Та що я їй такого зробило?' 😄", gif: "public/images/final.gif" },
    ...
    { text: "Мар'янко, ця кнопка вже втомилася тікати більше, ніж ти її ловити 😄", gif: "public/images/final.gif" },
