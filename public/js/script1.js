...
const answersNo = [
    { text: "Не знаю", gif: "public/images/pepe-shy.gif" },
    { text: "Ой, напевно промахнулася", gif: "public/images/pepe-flirty.gif", noHover: true },
    { text: "А привітання саме себе не відкриє", gif: "public/images/pepe-anxious.gif", noHover: true },
    ...
    { text: "Ну добре, я почекаю... секундочку", gif: "public/images/pepe-concerned.gif" },
    { text: "Там далі щось дуже миле", gif: "public/images/pepe-rain.gif" },
    ...
    { text: "Я б на твоєму місці вже натиснув Так ❤️", gif: "public/images/pepe-pen.gif" },
    { text: "А так???", gif: "public/images/pepe-fight.gif", noHover: true},
    { text: "Останній шанс перед магією", gif: "public/images/pepe-love-hit.gif" },
    { text: "Добре, тепер ловитимеш цю кнопку 😄", gif: "public/images/pepe-gun.gif" }
];
...
const runAwaySteps = [
    ...
    { text: "Краще натисни зелену кнопку", gif: "public/images/pepe-gun.gif" },
